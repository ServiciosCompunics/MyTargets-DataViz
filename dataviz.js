  ...
  const passeInfoMid  = document.getElementById( "passeInfoMid" );
  ...
  function showRundenInfo (properties) {
	...
	if( j===1 ){
		tbody.rows[i].insertCell(j).innerHTML = '<button onmouseover="showPasseInfoLeft(['+RDdata[i].rid+'],['+(i+1)+'])">'+Runden[rundenCols[j]]+'</button>';
	} else {
